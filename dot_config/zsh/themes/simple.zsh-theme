...
local _prompt='${prompt_pwd_color}$(_fishy_collapsed_wd)$(git_prompt_info)% %{$reset_color%}${new_line}${ret_prompt}%{$reset_color%}'

if [ "$SSH_CONNECTION" ]; then
    _prompt="${prompt_prompt_color}$(hostname):${_prompt}"
fi
